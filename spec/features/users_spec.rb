...
RSpec.feature "Users", type: :feature do
  ...
  feature "user" do
    ...
    scenario "look show page" do
      ...
      expect(page).to have_content "#{user.kana_last_name} #{user.kana_first_name}"
    ...
    scenario "unsubscribe" do
      visit users_users_path
      expect(page).to have_content "ようこそ#{user.last_name} #{user.first_name}さん"
      click_link "退会"
      ...
      expect(page).to_not have_content "ようこそ#{user.last_name} #{user.first_name}さん"
